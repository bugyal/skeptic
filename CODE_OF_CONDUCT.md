...
A note specific to this project: Skeptic exists to find faults in other people's
work. Report what the tool found, with evidence, and leave it there. Criticise
the task, never its author.
...
4. **Permanent ban** — a permanent ban from public interaction within the project.
